...
train_dataset = torchvision.datasets.ImageFolder(root='mnist-varres/train')
test_dataset = torchvision.datasets.ImageFolder(root='mnist-varres/test')
